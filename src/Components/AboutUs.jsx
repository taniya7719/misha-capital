...
>
  ...
  <img
    src="/about-1.png"
    className="rounded-3xl w-[280px] sm:w-[340px] lg:w-[415px] h-auto lg:h-[468px] shadow-lg"
  />
        ...
        Our Advisory Excellence
            ...
            {/* <div className="flex flex-col lg:flex-row justify-center gap-20 lg:gap-10">
              ...
              <div className="bg-[#0E78BE1A]   lg:w-[595.5px] h-auto lg:h-[769px] rounded-3xl p-7">
                <img src="/about-1.png" alt="Mr Manish Gupta" className="rounded-2xl object-cover mb-6 w-[531px] h-[468px]" />
...
Working capital, Promoter funding, ECB, IPO, and rights issue.
              ...
              <div className="bg-[#0E78BE1A] w-full  lg:w-[595.5px] h-auto lg:h-[769px] rounded-3xl p-7">
                <img src="/about-1.png" alt="Mr Manan Kedia" className="rounded-2xl object-cover mb-6 w-[531px] h-[468px]" />
                <h3 className="text-[26px] leading-[28px] font-semibold text-[#00365A]">
                  Mr. Manan Kedia
                </h3>
                <p className="text-[16px] leading-[25px] text-[#555555] mb-4">
